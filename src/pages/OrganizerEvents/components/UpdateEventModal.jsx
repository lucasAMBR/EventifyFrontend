    ...
    return (
        <div className={style.event_modal}>
            <div className={style.add_event}>
                ...
                <p>
                    Here you can update the informations of your already created events,
                    the guests will bem notified of this change
                </p>
                {loading && <p>Carregando...</p>}
                {currentEventData != null &&
                    currentEventData.type == "PRESENTIAL" &&
                    !loading && (
