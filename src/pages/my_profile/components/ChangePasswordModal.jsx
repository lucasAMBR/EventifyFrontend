            ...
            <div className={style.change_password_modal_content}>
                ...
                {selectedTab == "initial" && (
                    <>
                        <div className={style.change_password_modal_initial}>
                            <p>
                                To change your password, you need the change password code sent
                                to your email
                            </p>
                            <div className={style.change_password_modal_tabs}>
                                <button onClick={() => setSelectedTab("change_password")}>
                                    I already have the code
                                </button>
                                <button onClick={() => setSelectedTab("get_code")}>
                                    I need a new code
                                </button>
                            </div>
                        </div>
                ...
                {selectedTab == "change_password" && (
                    <>
                        <div className={style.change_password_modal_change_password}>
                            <p>
                                Enter the code you received by email, this account email and
                                your new password
                            </p>
                            <input
                                type="text"
                ...
                {selectedTab == "get_code" && (
                    <>
                        <div className={style.change_password_modal_change_password}>
                            <p>
                                Enter this account email to receive the change password code
                            </p>
                            <input
                                type="email"
                                placeholder="Email"
                                value={requestCodeEmailInput}
                                onChange={handleCodeEmailInputChange}
                            />
