...
export const UserCard = ({userId, profilePic, userName, usertype, followers, following, posts, fetchPopulars}) => {
        ...
        <div className={style.user_card}>
            <div className={style.card_infos}>
                ...
                <div className={style.user_details}>
                    <h3>{userName} {usertype == "ORGANIZER" && <span>Organizer</span>}</h3>
