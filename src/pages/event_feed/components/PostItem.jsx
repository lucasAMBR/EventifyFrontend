    ...
    return (
        <div className={style.post_item} style={removed ? { display: "none" } : {}}>
            <div className={style.post_header}>
                <div className={style.post_header_infos}>
                    <div className={style.owner_profile_pic}>
                        <img src={`http://localhost:8080${userProfilePic}`} alt={`${userName}'s profile`} />
                    </div>
                ...
                <div className={style.logged_user_post_menu}>
                    {(userId === loggedUser || userRole === "ORGANIZER") && (
                        <DropDownMenu
                            postId={postId}
            ...
            <div className={style.feedback_infos}>
                ...
                >
                    <ChatBubbleOutlineIcon sx={{ fill: "#004643" }} /> {`${liveCommentList.length}`}
                </div>
            </div>
            {commentModalIsOpen && (
                <CommentsModal
