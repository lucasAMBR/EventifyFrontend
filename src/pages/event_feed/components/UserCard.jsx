        ...
        <div className={style.user_card}>
            <div className={style.card_infos}>
                ...
                <div className={style.user_details}>
                    <h3 onClick={() => console.log(followingIds.includes(userId))}>
                ...
                <button
                    ...
                    className={
                        followingIds.includes(userId)
                            ? style.user_card_unfollow_button
                            : style.user_card_follow_button
                    }
                >
            ...
            {userRole == "ORGANIZER" && activeTab == "remove" && (
                <button
                    className={style.user_card_unfollow_button}
                    onClick={() => openRemoveMemberModal(userId)}
                >
                    Remove
                </button>
            )}
