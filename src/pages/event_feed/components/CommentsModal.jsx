        ...
        <div className={style.comment_modal_area}>
            <div className={style.comment_modal}>
                    ...
                    {commentList.length >= 1 &&
                        <>
                            {commentList.map((item, index) => (
                                <div className={style.comment_item} key={item.id}>
                                    <div className={style.comment_header}>
                                        <div className={style.comment_header_content}>
                                            ...
                                            <div className={style.comment_header_infos}>
                                                <h3
                                                    onClick={() => navigate(item.userId == loggedUser ? `/home/user/profile/me` : `/home/user/profile/${item.userId}`)}
                                        ...
                                        {item.userId == loggedUser &&
                                            <CommentDropDownMenu
                                                ...
                                                commentId={item.id}
                                                fetchComments={fetchCommentList}
                                            />
                                        }
                                    </div>
                ...
                <div className={style.comment_modal_add_new}>
                    ...
                    />
                    <button onClick={handlePublishComment}>
                        <SendIcon sx={{ fill: "#ffffff" }} />
                    </button>
                </div>
            </div>
        </div>
